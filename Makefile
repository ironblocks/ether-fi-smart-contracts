...
deploy-goerli-suite :; @forge script script/deploys/DeployEtherFISuite.s.sol:DeployEtherFiSuiteScript --rpc-url ${TESTNET_RPC_URL} --broadcast --verify  -vvvv --slow
...
deploy-goerli-phase-1.5:;  forge script script/deploys/DeployPhaseOnePointFive.s.sol:DeployPhaseOnePointFiveScript --rpc-url ${TESTNET_RPC_URL} --broadcast --verify  -vvvv --slow && bash script/extractABI.sh
...
deploy-goerli-tvlOracle:;  forge script script/deploys/DeployTVLOracle.s.sol:DeployTVLOracleScript --rpc-url ${TESTNET_RPC_URL} --broadcast --verify  -vvvv --slow && bash script/extractABI.sh

deploy-goerli-lpaPoints:;  forge script script/deploys/DeployLoyaltyPointsMarketSafe.sol:DeployLoyaltyPointsMarketSafeScript --rpc-url ${TESTNET_RPC_URL} --broadcast --verify  -vvvv --slow && bash script/extractABI.sh
...
deploy-goerli-node-operator :;  forge script script/specialized/DeployNewNodeOperatorManager.s.sol:DeployNewNodeOperatorManagerScript --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#upgrade commands (TESTNET)

upgrade-all-phase-one-goerli :;  forge script script/upgrades/StakingManagerUpgradeScript.s.sol:StakingManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/AuctionManagerUpgradeScript.s.sol:AuctionManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/EtherFiNodeScript.s.sol:EtherFiNodeUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/BNFTUpgradeScript.s.sol:BNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/TNFTUpgradeScript.s.sol:TNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/EtherFiNodesManagerUpgradeScript.s.sol:EtherFiNodesManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/ProtocolRevenueManagerUpgradeScript.s.sol:ProtocolRevenueManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-all-phase-one-point-five-goerli :; forge script script/upgrades/LiquidityPoolUpgradeScript.s.sol:LiquidityPoolUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/MembershipManagerUpgradeScript.s.sol:MembershipManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/MembershipNFTUpgradeScript.s.sol:MembershipNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/WeETHUpgradeScript.s.sol:WeEthUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/EETHUpgradeScript.s.sol:EETHUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/RegulationsManagerUpgradeScript.s.sol:RegulationsManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow 

upgrade-all-phase-two-goerli :; forge script script/upgrades/EtherFiOracleUpgradeScript.s.sol:EtherFiOracleUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/EtherFiAdminUpgradeScript.s.sol:EtherFiAdminUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && forge script script/upgrades/WithdrawRequestNFTUpgradeScript.s.sol:WithdrawRequestNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow

upgrade-goerli-staking-manager :;  forge script script/upgrades/StakingManagerUpgradeScript.s.sol:StakingManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-auction-manager :;  forge script script/upgrades/AuctionManagerUpgradeScript.s.sol:AuctionManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-etherfi-node :;  forge script script/upgrades/EtherFiNodeScript.s.sol:EtherFiNodeUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-bnft :;  forge script script/upgrades/BNFTUpgradeScript.s.sol:BNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-tnft :;  forge script script/upgrades/TNFTUpgradeScript.s.sol:TNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-eeth :;  forge script script/upgrades/EETHUpgradeScript.s.sol:EETHUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-etherfi_nodes_manager :;  forge script script/upgrades/EtherFiNodesManagerUpgradeScript.s.sol:EtherFiNodesManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-liquidity-pool :;  forge script script/upgrades/LiquidityPoolUpgradeScript.s.sol:LiquidityPoolUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-membership-manager :; forge script script/upgrades/MembershipManagerUpgradeScript.s.sol:MembershipManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-membership-nft :;  forge script script/upgrades/MembershipNFTUpgradeScript.s.sol:MembershipNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-nft-exchange :;  forge script script/upgrades/NFTExchangeUpgradeScript.s.sol:NFTExchangeUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-node-operator-manager :;  forge script script/upgrades/NodeOperatorManagerUpgradeScript.s.sol:NodeOperatorManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-protocol_revenue_manager :;  forge script script/upgrades/ProtocolRevenueManagerUpgradeScript.s.sol:ProtocolRevenueManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-regulations_manager :;  forge script script/upgrades/RegulationsManagerUpgradeScript.s.sol:RegulationsManagerUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-weeth :;  forge script script/upgrades/WeETHUpgradeScript.s.sol:WeEthUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-etherfi-oracle :;  forge script script/upgrades/EtherFiOracleUpgradeScript.s.sol:EtherFiOracleUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-etherfi-admin :;  forge script script/upgrades/EtherFiAdminUpgradeScript.s.sol:EtherFiAdminUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh

upgrade-goerli-withdraw-request-nft :;  forge script script/upgrades/WithdrawRequestNFTUpgradeScript.s.sol:WithdrawRequestNFTUpgrade --rpc-url ${TESTNET_RPC_URL} --broadcast --verify -vvvv --slow && bash script/extractABI.sh
...
update-goerli-admins:;  forge script script/specialized/UpdateAdminScripts.s.sol:UpdateAdmins --rpc-url ${TESTNET_RPC_URL} --broadcast -vvvv --slow
...
transfer-goerli-ownership:;  forge script script/specialized/TransferOwnership.s.sol:TransferOwnership --rpc-url ${TESTNET_RPC_URL} --broadcast -vvvv --slow
...
deploy-patch-2:;  forge script script/DeployPatch2.s.sol:DeployPatchV3 --rpc-url ${TESTNET_RPC_URL} --broadcast --verify  -vvvv --slow
